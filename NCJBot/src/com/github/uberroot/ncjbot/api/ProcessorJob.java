...
public abstract class ProcessorJob implements Runnable{
	 ...
	 */
	private final ProcessorJobEnvironment owner;
	...
	public ProcessorJob(File initData){
		owner = (ProcessorJobEnvironment) Thread.currentThread();
	}
	 ...
	 */
	public final ProcessorJobEnvironment getOwner(){
		return owner;
	}
